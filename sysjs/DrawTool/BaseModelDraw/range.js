...
var dataSourcePromise = viewer.dataSources.add(Cesium.KmlDataSource.load('./data/kml/facilities.kml', options));
dataSourcePromise.then(function(dataSource) {
   ...
   // customStyle();
    ...
    var toolbar = document.getElementById('Rangetoolbar');
