...
var DrawHelper = (function () {
    ...
    //开始画多边形==前   重写
    _.prototype.startDrawingPolygon2 = function (options) {
        var options = copyOptions(options, defaultSurfaceOptions);
        this.startDrawingPolyshape2(true, options);
    }
    //开始画多边形
    ...
    //-----
    //前进
    _.prototype.startDrawingPolyshape2 = function (isPolygon, options) {
        ...
        var poly;
        if (isPolygon) {
            poly = new DrawHelper.PolygonPrimitive2(options);
        }
        poly.asynchronous = false;
        primitives.add(poly);
    ...
    _.prototype.enhancePrimitives = function () {
        ...
        //Polyline--前进箭头
        DrawHelper.PolygonPrimitive2.prototype.setEditable = function () {
    ...
    _.DrawHelperWidget = (function () {
        ...
        function _(drawHelper, options) {
            ...
            var drawOptions = {
                ...
                qianjiArrowIcon: "./img/qianjijiantou.png",
                zhijiaoArrowIcon: "./img/zhijiaojiantou.png",
                jijieIcon: "./img/jijie.png",
            ...
            // })
            //直角
             addIcon('zhijiaoArrow', options.zhijiaoArrowIcon, '点击以绘制直箭头', function () {
            ...
            //前进
            addIcon('qianjiArrow', options.qianjiArrowIcon, '点击以绘制钳击箭头', function () {
                drawHelper.startDrawingPolygon2({
                    callback: function (positions, custom) {
                        _self.executeListeners({ name: 'polygonCreated2', positions: positions, custom: custom });
                    }
                });
            })
            //攻击
            ...
            toolbar.appendChild(div);
            addIcon('jijieArrow', options.jijieIcon, '点击以绘制集结', function () {
                addAre();
            });   
